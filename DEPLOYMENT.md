...
管理登入密碼由站主自訂，不強制長度（2026-09-14 江江拍板：統計後台不是機密，會公開分享）；注意這支也回傳訪客問咪卡的原話。保留每 IP 原子 5 次錯誤上限，未加全站硬鎖，避免陌生人把管理者一起鎖住。不能先比對猜中的密碼並繞過限流，那會讓攻擊者在額度耗盡後繼續用 200／429 差異辨識正確猜測。
