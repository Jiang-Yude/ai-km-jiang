...
window.ARTICLES = [
  /* ── 一間辦公室，講清楚什麼是圖譜工程（教學）── */
  {
    ...
    date: "2026-08-24",
    updated: "2026-08-24",
    title: "讓 AI 學會自己完成任務，不用我們守在電腦前監工！迴圈工程與圖譜工程說明",
    ...
    summary: "不會寫程式也能讓 AI 自己把一件事跑完，前提是把目標、規則、審核標準交代清楚。這篇用一間辦公室講清楚兩層，全程不用程式例子：先花兩分鐘講迴圈工程（一個助理把一件事自己做到好、自己檢查、自己修正，你不用在旁邊監工），再進到圖譜工程（好幾個助理怎麼接起來）。辦公室的三樣東西對應三個正式名詞：桌上的交接本是狀態、牆上的派工規則表是邊、上場的助理是節點。接著切開六個容易混淆的概念：知識圖譜、迴圈工程、專案管理、互相監督、自動化、狀態機與工作流編排，其中專案管理那個的關鍵差別是助理從人變成 AI，人會自己補上沒寫出來的判斷，AI 不會。最後誠實盤點作者自己的機制，哪些真的算、哪些其實不算，並給一段可直接複製的跨家審查提示詞。",
    tags: {
...
,
  ...
  },
  {
    ...
    date: "2026-07-11",
    updated: "2026-07-12",
    title: "半人馬會議：我帶我的 Agent，你帶你的 Agent，四方一起開",
