...
,
  ...
  /* ── 網站放 GitHub、Vercel 還是 Cloudflare？（教學）── */
  {
    ...
    external: { threads: null, vocus: null },
    related: ["who-can-see-your-site", "free-deploy-three-boundaries", "laptop-desktop-webpage-sync-icloud-git"]
  },
  ...
  /* ── 你的網頁其實沒鎖：網站內容防護六個等級（教學）── */
  {
    ...
    date: "2026-08-19",
    updated: "2026-08-19",
    title: "你的網頁其實沒鎖：網站內容防護六個等級，付費講義該放哪一層",
    ...
    external: { threads: null, vocus: null },
    related: ["github-vercel-cloudflare-compare", "free-deploy-three-boundaries", "laptop-desktop-webpage-sync-icloud-git"]
  }
];
