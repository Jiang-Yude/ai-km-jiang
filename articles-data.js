...
window.ARTICLES = [
...

  {
    ...
    audience: "用 AI 做好一頁網頁、卡在不知道怎麼讓別人看得到的人；聽過 Cloudflare 但只知道它跟擋攻擊有關的人；要拿這些服務去幫客戶做事、需要先確認哪些真的免費的專業工作者。",
...

  {
    ...
    audience: "想知道 AI 員工放進真實團隊一天怎麼運作的人；手上有重複性高的流程、想知道從哪一段開始交出去的人；不想只看漂亮成果、也想看失敗與限制的人。",
...

  {
    ...
    audience: "已經在用 AI 做重複工作，想知道哪一段該寫成程式、哪一段不該的人。",
